...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("To make pancakes you need 3 ingredients");
		System.out.println("Eggs, milk and flaour");
		...
		System.out.println("How much milk you have? in ml");
		userInput = new Scanner(System.in);
		...
		if (eggsAmount < eggsMin || milkAmount < milkMin || flourAmount < flourMin) {
			System.out.println("Inefficient material !! pancakes can't be made :(");
